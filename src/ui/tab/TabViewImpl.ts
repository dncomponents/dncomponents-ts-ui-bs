    ...
    export class Builder {
        ...
        public build(): TabViewImpl {
            ...
            if (this.__orientation == Orientation.VERTICAL) {
                let template = new TemplateParser(BootstrapUi.getUi().tabUi, true);
            ...
            let style = Builder.BASE_STYLE + HasStyle.appendString(this.__orientation) + HasStyle.appendString(this.__type);
